...
var apiInstance = new SwaggerJsClient.JsonWebKeyApi();

var set = "set_example"; // String | The set

var opts = { 
  'body': new SwaggerJsClient.JsonWebKeySetGeneratorRequest() // JsonWebKeySetGeneratorRequest | 
};
...
var opts = { 
  'body': new SwaggerJsClient.JsonWebKey() // JsonWebKey | 
};
...
var opts = { 
  'body': new SwaggerJsClient.JsonWebKeySet() // JsonWebKeySet | 
};
