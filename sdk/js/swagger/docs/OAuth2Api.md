...
var apiInstance = new SwaggerJsClient.OAuth2Api();

var id = "id_example"; // String | 

var body = new SwaggerJsClient.ConsentRequestAcceptance(); // ConsentRequestAcceptance | 
...
var body = new SwaggerJsClient.OAuth2Client(); // OAuth2Client | 
...
var body = new SwaggerJsClient.ConsentRequestRejection(); // ConsentRequestRejection | 
