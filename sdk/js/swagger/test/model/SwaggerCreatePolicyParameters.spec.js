...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerCreatePolicyParameters();
  });
  ...
  describe('SwaggerCreatePolicyParameters', function() {
    it('should create an instance of SwaggerCreatePolicyParameters', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerCreatePolicyParameters();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerCreatePolicyParameters);
    });
