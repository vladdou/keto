...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerListPolicyResponse();
  });
  ...
  describe('SwaggerListPolicyResponse', function() {
    it('should create an instance of SwaggerListPolicyResponse', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerListPolicyResponse();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerListPolicyResponse);
    });
