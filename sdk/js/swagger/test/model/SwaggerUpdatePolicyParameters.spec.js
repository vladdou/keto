...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerUpdatePolicyParameters();
  });
  ...
  describe('SwaggerUpdatePolicyParameters', function() {
    it('should create an instance of SwaggerUpdatePolicyParameters', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerUpdatePolicyParameters();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerUpdatePolicyParameters);
    });
