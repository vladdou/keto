...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerJwkUpdateSetKey();
  });
  ...
  describe('SwaggerJwkUpdateSetKey', function() {
    it('should create an instance of SwaggerJwkUpdateSetKey', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerJwkUpdateSetKey();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerJwkUpdateSetKey);
    });
