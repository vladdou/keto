...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerJwkCreateSet();
  });
  ...
  describe('SwaggerJwkCreateSet', function() {
    it('should create an instance of SwaggerJwkCreateSet', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerJwkCreateSet();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerJwkCreateSet);
    });
