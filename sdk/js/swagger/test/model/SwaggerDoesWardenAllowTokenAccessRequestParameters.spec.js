...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerDoesWardenAllowTokenAccessRequestParameters();
  });
  ...
  describe('SwaggerDoesWardenAllowTokenAccessRequestParameters', function() {
    it('should create an instance of SwaggerDoesWardenAllowTokenAccessRequestParameters', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerDoesWardenAllowTokenAccessRequestParameters();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerDoesWardenAllowTokenAccessRequestParameters);
    });
