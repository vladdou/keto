...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.JoseWebKeySetRequest();
  });
  ...
  describe('JoseWebKeySetRequest', function() {
    it('should create an instance of JoseWebKeySetRequest', function() {
      ...
      //var instane = new SwaggerJsClient.JoseWebKeySetRequest();
      //expect(instance).to.be.a(SwaggerJsClient.JoseWebKeySetRequest);
    });
