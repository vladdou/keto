...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerJwkUpdateSet();
  });
  ...
  describe('SwaggerJwkUpdateSet', function() {
    it('should create an instance of SwaggerJwkUpdateSet', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerJwkUpdateSet();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerJwkUpdateSet);
    });
