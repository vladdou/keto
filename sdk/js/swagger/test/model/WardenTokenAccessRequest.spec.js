...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.WardenTokenAccessRequest();
  });
  ...
  describe('WardenTokenAccessRequest', function() {
    it('should create an instance of WardenTokenAccessRequest', function() {
      ...
      //var instane = new SwaggerJsClient.WardenTokenAccessRequest();
      //expect(instance).to.be.a(SwaggerJsClient.WardenTokenAccessRequest);
    });
