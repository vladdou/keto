...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerOAuthConsentRequestPayload();
  });
  ...
  describe('SwaggerOAuthConsentRequestPayload', function() {
    it('should create an instance of SwaggerOAuthConsentRequestPayload', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerOAuthConsentRequestPayload();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerOAuthConsentRequestPayload);
    });
