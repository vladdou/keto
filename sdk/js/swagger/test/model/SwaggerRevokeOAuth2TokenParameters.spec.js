...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerRevokeOAuth2TokenParameters();
  });
  ...
  describe('SwaggerRevokeOAuth2TokenParameters', function() {
    it('should create an instance of SwaggerRevokeOAuth2TokenParameters', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerRevokeOAuth2TokenParameters();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerRevokeOAuth2TokenParameters);
    });
