...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.ConsentRequestManager();
  });
  ...
  describe('ConsentRequestManager', function() {
    it('should create an instance of ConsentRequestManager', function() {
      ...
      //var instane = new SwaggerJsClient.ConsentRequestManager();
      //expect(instance).to.be.a(SwaggerJsClient.ConsentRequestManager);
    });
