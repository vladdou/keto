...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.TokenAllowedRequest();
  });
  ...
  describe('TokenAllowedRequest', function() {
    it('should create an instance of TokenAllowedRequest', function() {
      ...
      //var instane = new SwaggerJsClient.TokenAllowedRequest();
      //expect(instance).to.be.a(SwaggerJsClient.TokenAllowedRequest);
    });
