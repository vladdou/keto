...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerListPolicyParameters();
  });
  ...
  describe('SwaggerListPolicyParameters', function() {
    it('should create an instance of SwaggerListPolicyParameters', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerListPolicyParameters();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerListPolicyParameters);
    });
