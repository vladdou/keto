...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerOAuthTokenResponse();
  });
  ...
  describe('SwaggerOAuthTokenResponse', function() {
    it('should create an instance of SwaggerOAuthTokenResponse', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerOAuthTokenResponse();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerOAuthTokenResponse);
    });
