...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerWardenTokenAccessRequestResponse();
  });
  ...
  describe('SwaggerWardenTokenAccessRequestResponse', function() {
    it('should create an instance of SwaggerWardenTokenAccessRequestResponse', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerWardenTokenAccessRequestResponse();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerWardenTokenAccessRequestResponse);
    });
