...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.JsonWebKeySetGeneratorRequest();
  });
  ...
  describe('JsonWebKeySetGeneratorRequest', function() {
    it('should create an instance of JsonWebKeySetGeneratorRequest', function() {
      ...
      //var instane = new SwaggerJsClient.JsonWebKeySetGeneratorRequest();
      //expect(instance).to.be.a(SwaggerJsClient.JsonWebKeySetGeneratorRequest);
    });
