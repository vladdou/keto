...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerRejectConsentRequest();
  });
  ...
  describe('SwaggerRejectConsentRequest', function() {
    it('should create an instance of SwaggerRejectConsentRequest', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerRejectConsentRequest();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerRejectConsentRequest);
    });
