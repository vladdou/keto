...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.WardenAccessRequestResponse();
  });
  ...
  describe('WardenAccessRequestResponse', function() {
    it('should create an instance of WardenAccessRequestResponse', function() {
      ...
      //var instane = new SwaggerJsClient.WardenAccessRequestResponse();
      //expect(instance).to.be.a(SwaggerJsClient.WardenAccessRequestResponse);
    });
