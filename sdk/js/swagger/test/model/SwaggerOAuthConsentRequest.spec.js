...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerOAuthConsentRequest();
  });
  ...
  describe('SwaggerOAuthConsentRequest', function() {
    it('should create an instance of SwaggerOAuthConsentRequest', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerOAuthConsentRequest();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerOAuthConsentRequest);
    });
