...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerDoesWardenAllowAccessRequestParameters();
  });
  ...
  describe('SwaggerDoesWardenAllowAccessRequestParameters', function() {
    it('should create an instance of SwaggerDoesWardenAllowAccessRequestParameters', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerDoesWardenAllowAccessRequestParameters();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerDoesWardenAllowAccessRequestParameters);
    });
