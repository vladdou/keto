...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.WardenTokenAccessRequestResponse();
  });
  ...
  describe('WardenTokenAccessRequestResponse', function() {
    it('should create an instance of WardenTokenAccessRequestResponse', function() {
      ...
      //var instane = new SwaggerJsClient.WardenTokenAccessRequestResponse();
      //expect(instance).to.be.a(SwaggerJsClient.WardenTokenAccessRequestResponse);
    });
