...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerJwkSetQuery();
  });
  ...
  describe('SwaggerJwkSetQuery', function() {
    it('should create an instance of SwaggerJwkSetQuery', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerJwkSetQuery();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerJwkSetQuery);
    });
