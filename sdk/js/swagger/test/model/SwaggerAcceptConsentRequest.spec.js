...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SwaggerAcceptConsentRequest();
  });
  ...
  describe('SwaggerAcceptConsentRequest', function() {
    it('should create an instance of SwaggerAcceptConsentRequest', function() {
      ...
      //var instane = new SwaggerJsClient.SwaggerAcceptConsentRequest();
      //expect(instance).to.be.a(SwaggerJsClient.SwaggerAcceptConsentRequest);
    });
