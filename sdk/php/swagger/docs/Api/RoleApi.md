...
$api_instance = new hades\SDK\Api\RoleApi();
$id = "id_example"; // string | The id of the group to modify.
$body = new \hades\SDK\Model\GroupMembers(); // \hades\SDK\Model\GroupMembers | 
 ...
 **body** | [**\hades\SDK\Model\GroupMembers**](../Model/GroupMembers.md)|  | [optional]
...
# **createRole**
> \hades\SDK\Model\Role createRole($body)
...
$api_instance = new hades\SDK\Api\RoleApi();
$body = new \hades\SDK\Model\Role(); // \hades\SDK\Model\Role | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\hades\SDK\Model\Role**](../Model/Role.md)|  | [optional]

### Return type

[**\hades\SDK\Model\Role**](../Model/Role.md)
...
# **getRole**
> \hades\SDK\Model\Role getRole($id)
...
# **listRoles**
> \hades\SDK\Model\Role[] listRoles($member, $limit, $offset)
