...
$api_instance = new keto\SDK\Api\OAuth2Api();
$id = "id_example"; // string | 
$body = new \keto\SDK\Model\ConsentRequestAcceptance(); // \keto\SDK\Model\ConsentRequestAcceptance | 
...
------------- | ------------- | ------------- | -------------
 **id** | **string**|  |
 **body** | [**\keto\SDK\Model\ConsentRequestAcceptance**](../Model/ConsentRequestAcceptance.md)|  |
...
# **createOAuth2Client**
> \keto\SDK\Model\OAuth2Client createOAuth2Client($body)
...
$api_instance = new keto\SDK\Api\OAuth2Api();
$body = new \keto\SDK\Model\OAuth2Client(); // \keto\SDK\Model\OAuth2Client | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\keto\SDK\Model\OAuth2Client**](../Model/OAuth2Client.md)|  |

### Return type

[**\keto\SDK\Model\OAuth2Client**](../Model/OAuth2Client.md)
...
# **getOAuth2Client**
> \keto\SDK\Model\OAuth2Client getOAuth2Client($id)
...
> \keto\SDK\Model\OAuth2ConsentRequest getOAuth2ConsentRequest($id)
...
[**\keto\SDK\Model\OAuth2ConsentRequest**](../Model/OAuth2ConsentRequest.md)
...
# **getWellKnown**
> \keto\SDK\Model\WellKnown getWellKnown()
...
[**\keto\SDK\Model\WellKnown**](../Model/WellKnown.md)
...
> \keto\SDK\Model\OAuth2TokenIntrospection introspectOAuth2Token($token, $scope)
...
[**\keto\SDK\Model\OAuth2TokenIntrospection**](../Model/OAuth2TokenIntrospection.md)
...
# **listOAuth2Clients**
> \keto\SDK\Model\OAuth2Client[] listOAuth2Clients()
...
# **oauthToken**
> \keto\SDK\Model\InlineResponse2001 oauthToken()
...
[**\keto\SDK\Model\InlineResponse2001**](../Model/InlineResponse2001.md)
...
$api_instance = new keto\SDK\Api\OAuth2Api();
$id = "id_example"; // string | 
$body = new \keto\SDK\Model\ConsentRequestRejection(); // \keto\SDK\Model\ConsentRequestRejection | 
...
------------- | ------------- | ------------- | -------------
 **id** | **string**|  |
 **body** | [**\keto\SDK\Model\ConsentRequestRejection**](../Model/ConsentRequestRejection.md)|  |
...
# **updateOAuth2Client**
> \keto\SDK\Model\OAuth2Client updateOAuth2Client($id, $body)
...
# **userinfo**
> \keto\SDK\Model\SwaggeruserinfoResponsePayload userinfo()
...
[**\keto\SDK\Model\SwaggeruserinfoResponsePayload**](../Model/SwaggeruserinfoResponsePayload.md)
...
# **wellKnown**
> \keto\SDK\Model\JsonWebKeySet wellKnown()
