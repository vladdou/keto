...
class HealthApi
{
     ...
     * @return \keto\SDK\Model\InlineResponse200
     */
     ...
     *
     * @throws \keto\SDK\ApiException on non-2xx response
     * @return array of \keto\SDK\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInstanceStatusWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\keto\SDK\Model\InlineResponse200',
                '/health/status'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\keto\SDK\Model\InlineResponse200', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\keto\SDK\Model\InlineResponse200', $e->getResponseHeaders());
