 ...
 * @return void
 */
func (a RoleApi) AddMembersToRole(id string, body GroupMembers) (*APIResponse, error) {
 ...
 * @return void
 */
func (a RoleApi) RemoveMembersFromRole(id string, body GroupMembers) (*APIResponse, error) {
